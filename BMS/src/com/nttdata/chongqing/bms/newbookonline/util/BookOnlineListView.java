 ...
 *
 */
public class BookOnlineListView extends ListView implements OnScrollListener {
	...
	public BookOnlineListView(Context context) {
		super(context);
		init(context);
	}

	public BookOnlineListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		// 自定义listview要设置背景为白色
		// setCacheColorHint(R.string.transparent);
